...
{
	private readonly List<CollisionObject2D> _predators = [];
	private readonly List<CollisionObject2D> _prey = [];
	...
	private Vector2 ComputeMoveVectorFor(List<CollisionObject2D> entities)
	{
	...
	public override void _Ready()
	{
		...
		// OnNodeEntered parameter type (Node2D) is less derived than AreaEntered parameter
		// type (Area2D, which inherits from Node2D)
	...
	{
		if (body is not CollisionObject2D entity)
			return;
